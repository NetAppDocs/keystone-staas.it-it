...
| Descrizione del problema | Dopo la correzione | Fissato in rilascio 
 ...
 a| 
Nella scheda *Andamento dei consumi* di Digital Advisor, il grafico a raffica dei consumi fatturati mostra valori diversi per lo stesso periodo di fatturazione a seconda dell'intervallo di date selezionato.
 a| 
Corretto
 a| 
2026-08-31
