...
| image:check.png["segno di spunta"] | Nessuno 
|===
Per ulteriori informazioni sulla distribuzione, vedi link:../concepts/infra.html["Scopri l'infrastruttura Keystone"] e link:..//concepts/components.html["Componenti necessari per i servizi Keystone"].
