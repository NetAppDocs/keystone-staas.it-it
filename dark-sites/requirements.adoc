...
---
= Requisiti di installazione per Keystone Collector in modalità privata
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Ogni mese, esporta un file da Keystone Collector e invialo via email al team di supporto NetApp. Per ulteriori informazioni su come contattare il team di supporto, consulta link:../concepts/support-services.html["Servizi di supporto per Keystone"].
