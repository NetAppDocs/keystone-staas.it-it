...
* Ogni mese, esporta un file da Keystone Collector e invialo via e-mail al team di supporto NetApp . Per maggiori informazioni su come contattare il team di supporto, fare riferimento a link:../concepts/support-services.html["Ottieni aiuto con Keystone"].
