...
Puoi contattare il team di supporto Keystone per abbonarti a Keystone versione 3 (v3). Per ulteriori dettagli, consulta link:https://docs.netapp.com/us-en/keystone-staas/concepts/support-services.html["Servizi di supporto per Keystone"].
