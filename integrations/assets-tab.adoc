...
+
Vengono visualizzate informazioni dettagliate sui volumi nei cluster, tra cui nome del volume, numero di serie del nodo, nome del cluster, host name e livelli di servizio delle prestazioni. È inoltre possibile monitorare la capacità fornita, l'utilizzo logico e fisico, i dati cold e hot.
