...
* Accordo sul livello di servizio: Se gli abbonamenti soddisfano gli obiettivi di sostenibilità definiti nel contratto SLA (Service Level Agreement). Se le sottoscrizioni soddisfano i criteri SLA, lo stato può essere visualizzato come _all OK_.
