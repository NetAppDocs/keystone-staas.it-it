...
Quando si controlla l'abbonamento secondario, si può notare che il grafico a barre per il livello di servizio _Extreme_ (base Service leverent Usagel) nello stesso punto di raccolta dati del sito partner viene invertito, e la disaggregazione dei consumi nei siti primario e mirror è rispettivamente di 1,05 TiB e 1,02 TiB.
