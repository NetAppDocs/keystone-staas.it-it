...
Gli SLA (Service Level Agreement) sono un componente chiave delle soluzioni di cloud storage NetApp. Gli SLA mirano a fornire una soluzione storage efficace, di alta qualità e affidabile come parte delle offerte di servizi Keystone STaaS. La scheda *Dettagli SLA* è disponibile solo se si dispone di uno SLA di sostenibilità valido con NetApp.
...
[%collapsible]
====
La scheda *SLA* di Sustainability è disponibile solo se si dispone di un contratto SLA (Service Level Agreement) di Sustainability valido con NetApp. Per informazioni sulla sostenibilità in Keystone STaaS, consulta link:../concepts/sla-sustainability.html["SLA di sostenibilità per Keystone"].

La scheda *Sustainability SLA* fornisce i dettagli dello SLA di Sustainability.

.Fasi
. Fare clic su *Dettagli SLA > SLA di Sustainability*.
