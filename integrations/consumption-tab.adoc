...
+
Il grafico a linee mostra i dati storici sui consumi e consente agli utenti di analizzare le tendenze in un intervallo di date selezionato. Il grafico mostra metriche quali capacità utilizzata (capacità di archiviazione totale, inclusi sia i dati che i dati snapshot), dati (capacità di archiviazione utilizzata dai dati utente) e snapshot (capacità di archiviazione utilizzata dai dati snapshot), insieme alla capacità impegnata e di picco. In base all'intervallo di date della query, i grafici di utilizzo mostrano fino a 30 punti di raccolta di dati. Puoi passare il cursore del mouse sul grafico per visualizzare la ripartizione dell'utilizzo in ciascun punto di raccolta di dati.
