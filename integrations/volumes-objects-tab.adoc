...
+
È possibile utilizzare *Nascondi/Mostra colonne* per aggiungere o rimuovere colonne visualizzate nella tabella. Per impostazione predefinita, la tabella mostra le preferenze di colonna salvate in precedenza. Le colonne aggiunte di recente, come *Reparto* o *Impronta totale*, sono nascoste per impostazione predefinita e devono essere selezionate manualmente per essere visualizzate nella tabella. È possibile selezionare o deselezionare qualsiasi colonna e le preferenze verranno salvate per un utilizzo successivo. Quando si scarica il report CSV, tutte le colonne disponibili vengono incluse nell'esportazione indipendentemente dalle preferenze di visualizzazione.
