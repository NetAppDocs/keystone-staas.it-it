...
summary: 'Prerequisiti per l"installazione di Keystone Collector su sistemi Linux' 
---
...
[role="lead"]
Sono necessarie alcune configurazioni per l'installazione di Keystone Collector su sistemi Linux.

.Prerequisiti per il server Linux:
